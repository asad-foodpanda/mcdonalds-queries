...
with data as (select count(distinct case when o.decline_reason.title in ("No rider available","Customer received food in inedible condition","Customer received food totally spilled","Customer received order too late (>1h)","Customer received wrong order","Outside of delivery area","Rider accident","Rider unreachable","Unable to find or reach customer") then o.code end) as inaccurate_orders,
