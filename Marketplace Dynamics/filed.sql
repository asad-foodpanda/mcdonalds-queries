...
with data as (select count(distinct case when o.decline_reason.title in ("No rider available","No rider available","Outside of delivery area","Rider accident","Rider unreachable","Unable to find or reach customer","No rider available","Outside of delivery area","Rider accident","Rider unreachable","Unable to find or reach customer") then o.code end) as failed_orders,
...
select failed_orders / gross_orders as failed from data